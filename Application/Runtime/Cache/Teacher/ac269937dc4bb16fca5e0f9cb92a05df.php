...
<head>
    ...
    <![endif]-->
    <script src="/competition/Public/assets/js/ace-elements.min.js"></script>
    <script src="/competition/Public/assets/js/ace.min.js"></script>
    ...
    <script src="/competition/Public/js/jquery.nicescroll.js" type="text/javascript"></script>
    <script type="text/javascript">
        $(function(){
...
<div class="navbar navbar-default" id="navbar">
	...
	<div class="navbar-container" id="navbar-container">
		<div class="navbar-header pull-left">
			<img src="/competition/Public/images/潍坊科技学院校徽.png" height="75" width="500" />
		</div>
		<!-- /.navbar-header -->
		...
		<div class="sidebar" id="sidebar">
			...
			<div id="menu_style" class="menu_style">
				<ul class="nav nav-list" id="nav_list">
					...
					<li><a href="#" class="dropdown-toggle"><i class="icon-list"></i><span class="menu-text"> 注册页面 </span><b class="arrow icon-angle-down"></b></a>
						<ul class="submenu">
							<li class="home"><a href="javascript:void(0)" name="/competition/index.php/Teacher/Index/register.html" title="老师注册" class="iframeurl"><i class="icon-double-angle-right"></i>老师注册</a></li>
							<li class="home"><a href="javascript:void(0)" name="/competition/index.php/Teacher/Index/exitfrom.html" title="信息修改" class="iframeurl"><i class="icon-double-angle-right"></i>信息修改</a></li>
							<li class="home"><a href="javascript:void(0)" name="/competition/index.php/Teacher/Index/article_add.html" title="申请竞赛" class="iframeurl"><i class="icon-double-angle-right"></i>申请竞赛</a></li>
