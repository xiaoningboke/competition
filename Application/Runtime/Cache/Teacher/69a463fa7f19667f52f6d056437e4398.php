 ...
 <div class="admin_info_style">
   <div class="admin_modify_style" id="Personal">
     <div class="type_title">管理员信息 </div>
      <div class="xinxi">
        <div class="form-group"><label class="col-sm-3 control-label no-padding-right" for="form-field-1">名称： </label>
          <div class="col-sm-9"><input type="text" name="name" id="website-title" value="" class="col-xs-7 text_info" disabled="disabled">
          ...
          <div class="col-sm-9"><input type="text" name="name" id="website-title" value="孟繁森" class="col-xs-7 text_info" disabled="disabled"></div>
          </div>
          <div class="form-group"><label class="col-sm-3 control-label no-padding-right" for="form-field-1">职称： </label>
          <div class="col-sm-9"><input type="text" name="technical" id="website-title" value="学生" class="col-xs-7 text_info" disabled="disabled"></div>
          </div>
          <div class="form-group"><label class="col-sm-3 control-label no-padding-right" for="form-field-1">邮箱： </label>
          <div class="col-sm-9"><input type="text" name="email" id="website-title" value="567890@qq.com" class="col-xs-7 text_info" disabled="disabled"></div>
          </div>
          <div class="form-group"><label class="col-sm-3 control-label no-padding-right" for="form-field-1">手机号码： </label>
          <div class="col-sm-9"><input type="text" name="phone" id="website-title" value="15653477752" class="col-xs-7 text_info" disabled="disabled"></div>
          </div>
...
function save_info(){
  ...
  function tj(jsonCon){
    ...
    console.log(jsonCon);
         $.ajax({
             type: "POST",
             url: "<?php echo U('Home/index/exitfrom');?>",
             data: {username:jsonCon},
             //dataType: "json",
